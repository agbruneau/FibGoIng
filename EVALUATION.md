...
4.  **Vérification Formelle :**
    *   *Idée :* Prouver mathématiquement la correction des implémentations optimisées (notamment les échanges de pointeurs) pour garantir l'absence d'effets de bord.
