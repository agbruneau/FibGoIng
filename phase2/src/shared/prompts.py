...
========================
Prompts système avec support RAG.
"""
...
# =============================================================================
# Agent 2 : Senior Risk Analyst (avec RAG)
# =============================================================================
...
2. Utilise la recherche dans les politiques pour trouver les règles applicables.
3. Calcule le ratio dette/revenu (DTI).
4. Synthétise dans un score de 0 (Sûr) à 100 (Risqué).
